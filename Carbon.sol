...
contract CarbonAssetRecord is ERC721, ERC721Enumerable, Ownable {
    ...
    mapping(address => uint) public mintableNums; 
    string private _baseURIextended;

    constructor(
        
    ) ERC721("CarbonAssetRecord", "CarbonAssetRecord") {
    ...
    function mintToken(uint numberOfTokens) public {
        ...
        require(numberOfTokens <= mintableNums[msg.sender], "You have not enough access to mint Tokens");
        ...
        mintableNums[msg.sender] = mintableNums[msg.sender] - numberOfTokens;
    }

    function giveRightsToWallet(address _target, uint _numberOfItems) public onlyOwner {
        mintableNums[_target] = mintableNums[_target] + _numberOfItems;
    }

    function initializeRightsToWallet(address _target ) public onlyOwner {
        mintableNums[_target] = 0;
    }

    function changeMaxTokens (uint _max) public onlyOwner {
        MAX_TOKENS = _max;
    }
